##### we will compare simple minear and polynominal regression to see the != also to see in his set polynominal is better
'''
...
poly_reg = PolynomialFeatures(degree= 4) # is the expsoant of x
